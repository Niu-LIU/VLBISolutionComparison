...
def print_outlier(source, ind_outl, flog):
    outliers = np.extract(ind_outl, source)
    print('## %d Outliers:\n' % outliers.size, outliers, file=flog)
...
# Print the result
    ...
    # Print the outliers
    print_outlier(sou, ind_outl1, flog)
    # For tex file.
    print('## for degree 1:\n',
          '## Rotation component:\n',
...
#     print('##   correlation coefficients are:\n', corr2, file=flog)
#     # Print the outliers
#     print_outlier(sou, ind_outl2, flog)
    # # For tex file.
    # print('## for degree 2:\n',
    #       '## Rotation component:\n',
    #       ' $%+4d \pm$ %3d &' * 3 % (wx, ewx, wy, ewy, wz, ewz),
