...
# Check EOP and Nutation offsets.
print("# Check EOP")
print("#1.1) check .eob file wrt. C04 series:\n"
...
print("#1.2) Check Nutation offsets wrt. IAU 2006/2000A Precession-Nutation:\n"
      "  .eob file: %s.eob" % sol_lab)
...
# os.system("~/Astronomy/Works/201711_GDR2_ICRF3/progs/sou_elim %s/%s.sou"
#           % (sol_dir, sol_lab))
