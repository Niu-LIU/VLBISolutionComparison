...
def test_code(flag):
    ...
    if flag is 1:
        ...
        # print('To verify the result of Table 1 in Titov et al.(2011):')
        # # Result in the paper
        ...
        # print('To verify the result of Table 1 in Titov et al.(2013):')
        # # Result in the paper
        ...
        # print('To verify the result of Table 1 in Titov et al.(2018):')
        # # Result in the paper
        # dip = np.array([[-0.7, -5.9, -2.2],
        #                 [-2.6, -5.1, -1.1],
        #                 [-0.4, -5.7, -2.8],
        ...
        print('To verify the result of Table 1 in paper of David Mayer:')
        # Result in the paper
